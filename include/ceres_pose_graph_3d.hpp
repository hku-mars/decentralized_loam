...
inline bool out_put_poses(const std::string& filename, const MapOfPoses& poses) {
  std::fstream outfile;
...
// graph constraints.
inline void BuildOptimizationProblem( const VectorOfConstraints &constraints,
...
inline void pose_graph_optimization( MapOfPoses &         poses,
...
inline void pose_graph_optimization_from_g2o_file( std::string &in_file_name )
{
    std::cout << "*************************************" << std::endl;
